  ...
  return (
    <Layout>
      <div className="flex flex-row">
        <div className="flex flex-col flex-grow text-whisper-white w-5/12 pr-20">
          ...
          <p className="font-lato text-justify pb-2">
            Before the COVID-19 pandemic in 2018, I had some business ideas that
            ...
            jump higher to achieve my goal, and that's why I learned
            programming. While working as a part-time instructor in
        ...
        <div className="flex flex-col flex-shrink text-whisper-white w-5/12">
          <h1 className="font-oswald text-3xl uppercase font-semibold pb-5">
            Tech Stack
          </h1>
          <h4 className="font-lato font-semibold pb-2">Frontend</h4>
          <div>
          ...
          <h4 className="font-lato font-semibold pb-2 pt-5">Backend</h4>
          <div>
            <div className="flex flex-row flex-wrap gap-4 items-center pb-2">
              <img
                src={nodeLogo}
          ...
          <h4 className="font-lato font-semibold pb-2 pt-5">Database</h4>
          <div>
            <div className="flex flex-row flex-wrap gap-4 items-center pb-2">
              <img
                src={mongodbLogo}
          ...
          <h4 className="font-lato font-semibold pb-2 pt-5">Design</h4>
          <div>
